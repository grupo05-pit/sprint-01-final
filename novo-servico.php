<!-- SCRIPT DA PÁGINA FORMS DA CRIAÇÃO DO SERVIÇO DO PRESTADOR -->
...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO servicos(nome_serv,finalidade,preco,dias,cidades,tam_equipe,img_serv) VALUES ('$nome_serv','$finalidade','$preco','$dias','$cidades','$tam_equipe','$img_serv')");
        ...
        <form action="novo-servico.php" method="POST" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="inputBox">
                    ...
                    <label for="fotos" class="labelInput">Fotos do serviço</label>
